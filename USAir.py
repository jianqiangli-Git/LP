...
if __name__ == "__main__":
    USAir_path = r"C:\Users\Tang\Desktop\data\USAir.txt"
    edges=RF(USAir_path)
    print("========================================== Running USAir network======================================")
    #定义试验次数
    AUC = {}
    run_num = 5
    for num in range(run_num):
        AUC_Hn_HSRW = {}
        print("AUC_Hn_HSRW:",AUC_Hn_HSRW)
        ...
        Hn_Pmatrix = LP.getNPMatrixDict(P,6)
        NProbMatrix = LP.getNVerTransProbMatrixDict(Hn_Pmatrix, len(v))
        HSRW = LP.getHSRW(h['h(1)'], eforPre, NProbMatrix, 6)
        ...
        for n in Hn_HSRW:
            ...
            AUC_Hn_HSRW[n] = LP.getAUC(te, Hn_HSRW[n])
        print(AUC_Hn_HSRW)
        AUC[num] = AUC_Hn_HSRW
